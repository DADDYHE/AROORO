...
check('mallService/index.js 注入全局限流', /initGlobalRateLimitFromDb\s*\(/.test(mallIdx || ''))
...
check('activityService/index.js 注入全局限流', /initGlobalRateLimitFromDb\s*\(/.test(actIdx || ''))
