 ...
 *   5. scripts/build-all-services.js TARGETS 包含 notify.js
...
check('build-all-services.js TARGETS 包含 notify.js', /notify\.js/.test(buildScript || ''))
...
if (pkg) {
  try {
    ...
    check('package.json ci:check 包含 audit:s26-payment-notify-ts:strict', /(?:audit:s26-payment-notify-ts:strict|audit:all:strict)/.test(cfg.scripts['ci:check'] || ''))
  } catch (e) {
