 ...
 *   5. scripts/build-payment-service.js TARGETS 包含 pay.js
...
check('build-payment-service.js TARGETS 包含 pay.js', /pay\.js/.test(buildScript || ''))
...
if (pkg) {
  try {
    ...
    check('package.json ci:check 包含 audit:s25-payment-pay-ts:strict', /audit:s25-payment-pay-ts:strict/.test(cfg.scripts['ci:check'] || ''))
  } catch (e) {
