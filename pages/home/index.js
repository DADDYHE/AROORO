    ...
    try {
      ...
      if (!this.data.isLoggedIn && app.globalData.userInfo) {
        ...
        const userInfo = {
          ...app.globalData.userInfo,
          avatarUrl: app.globalData.userInfo.avatarUrl || '',
          role: centralIdentityManager.getCurrentRole() || 'owner'
        }
        ...
        stateManager.setState('home', {
          isLoggedIn: true,
          userInfo: userInfo,
          userRole: centralIdentityManager.getCurrentRole() || 'owner'
        })
      ...
      if (this.data.isLoggedIn && app.globalData.userInfo) {
        ...
        if (JSON.stringify(this.data.userInfo) === JSON.stringify(globalUserInfo) &&
            this.data.userRole === (centralIdentityManager.getCurrentRole() || 'owner')) {
          // 确保 tabBar 选中状态正确
          this.setTabBarSelected()
          return
        }
