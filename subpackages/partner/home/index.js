...
Page({
  ...
  data: {
    ...
    incomeSummary: null,
    modules: [
      { id: 'income', title: '佣金管理', desc: '查看佣金与提现', iconPath: '/images/icons/partner-wallet.svg', path: '/subpackages/partner/income/index' },
      { id: 'serviceIncome', title: '收入管理', desc: '查看服务收入', iconPath: '/images/icons/partner-trend.svg', path: '/subpackages/partner/service-income/index' },
      { id: 'referral', title: '推荐管理', desc: '查看带货数据', iconPath: '/images/icons/partner-users.svg', path: '/subpackages/partner/referral/index' },
      { id: 'activity', title: __i18nT('BIZ_E4OKK2'), desc: '管理活动与报名', iconPath: '/images/icons/partner-flag.svg', path: '/subpackages/partner/activity-list/index' },
      { id: 'hosting', title: '家庭寄养', desc: '管理寄养家庭信息', iconPath: '/images/icons/hosting-home-heart.svg', path: '/subpackages/partner/hosting-profile/index' },
      { id: 'feeding', title: __i18nT('BIZ_AGSVKI'), desc: '管理服务与订单', iconPath: '/images/icons/partner-paw.svg', path: '/subpackages/partner/feeding/index' },
      { id: 'application', title: __i18nT('BIZ_FD7PYN'), desc: '查看审核进度', iconPath: '/images/icons/partner-clipboard.svg', path: '/subpackages/partner/application/index' },
    ],
  },
