...
Page({
  ...
  async onSubmit() {
    console.log('[confirm-service] onSubmit called, isSubmitting:', this.data.isSubmitting)
  ...
  async onConfirmPayment() {
    ...
    try {
      console.log('[confirm-service] Creating feeding order...')
      ...
      console.log('[confirm-service] Order result:', result)
      ...
      console.log('[confirm-service] Calling PaymentService.pay, amount:', payAmount)
