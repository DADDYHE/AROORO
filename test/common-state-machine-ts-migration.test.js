...
describe('Sprint 13: state-machine.js → .ts 迁移', () => {
  ...
  test('state-machine.js 应含 eslint-disable 标记（tsc 产物，lint 由 .eslintrc.json override 处理）', () => {
  ...
  test('build:common 应处理 state-machine.js（build-all-services.js TARGETS）', () => {
    const buildScript = fs.readFileSync(
      path.resolve(__dirname, '..', 'scripts', 'build-all-services.js'),
      'utf8'
    )
    expect(buildScript).toMatch(/state-machine\.js/)
  })
