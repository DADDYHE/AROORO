 ...
 */
async function reportVirtualShippingForServiceOrder(orderType, existingOrder, transactionId) {
    if (!transactionId || !existingOrder || !existingOrder._id) {
        return;
    }
