...
exports.getCodesByGroup = exports.exportLocaleDictionary = exports.resolveI18nMessage = exports.ERROR_CODE_GROUPS = exports.DEFAULT_I18N = void 0;
// =====================================================================
// 内置字典
// =====================================================================
/**
...
function resolveI18nMessage(code, locale = 'zh-CN', customOverrides) {
    ...
    if (exports.DEFAULT_I18N[code]?.[locale]) {
        return exports.DEFAULT_I18N[code][locale];
    }
    // 3. fallback to zh-CN
    if (exports.DEFAULT_I18N[code]?.['zh-CN']) {
        return exports.DEFAULT_I18N[code]['zh-CN'];
    }
    // 4. literal code
    return code;
}
 ...
 */
function exportLocaleDictionary(locale, customOverrides) {
    const result = {};
 ...
 */
function getCodesByGroup(group) {
    return Object.keys(exports.ERROR_CODE_GROUPS)
        .filter(code => exports.ERROR_CODE_GROUPS[code] === group);
}
exports.getCodesByGroup = getCodesByGroup;
