...
exports.exportLocaleDictionary = exports.resolveI18nMessage = exports.DEFAULT_LOCALE = exports.SUPPORTED_LOCALES = exports.ERROR_CODE_GROUPS = exports.DEFAULT_I18N = void 0;
exports.DEFAULT_I18N = {
    // === 通用 / 校验 ===
 ...
 */
function resolveI18nMessage(code, locale) {
    if (!code || typeof code !== 'string') {
        return '';
    }
    const useLocale = exports.SUPPORTED_LOCALES.includes(locale || '')
        ? locale
        : exports.DEFAULT_LOCALE;
    const entry = exports.DEFAULT_I18N[code];
    if (!entry) {
        return code;
    }
    return entry[useLocale] || entry[exports.DEFAULT_LOCALE] || code;
}
exports.resolveI18nMessage = resolveI18nMessage;
/**
 * 导出指定 locale 的扁平字典（{ CODE: '...' }），供 build-i18n.js 生成 CDN JSON
 */
function exportLocaleDictionary(locale) {
    const useLocale = exports.SUPPORTED_LOCALES.includes(locale || '')
        ? locale
        : exports.DEFAULT_LOCALE;
    const dict = {};
    for (const code of Object.keys(exports.DEFAULT_I18N)) {
        const entry = exports.DEFAULT_I18N[code];
        dict[code] = (entry && entry[useLocale]) || (entry && entry[exports.DEFAULT_LOCALE]) || code;
    }
    return dict;
}
exports.exportLocaleDictionary = exportLocaleDictionary;
// CommonJS 兼容导出（与 tsc 编译产物 _mod.exports 模式对齐）
const _mod = module;
_mod.exports = {
    DEFAULT_I18N: exports.DEFAULT_I18N,
    ERROR_CODE_GROUPS: exports.ERROR_CODE_GROUPS,
