...
exports.BOOKING_KEY_RELEASED_STATUSES = exports.BOOKING_KEY_ACTIVE_STATUSES = exports.releasedBookingKey = exports.buildBookingKey = void 0;
/** 构造唯一键：用户 + 家庭 + 起止日期 + 起止时刻 */
function buildBookingKey(params) {
...
exports.buildBookingKey = buildBookingKey;
/** 释放键位：订单进入终态（cancelled / rejected / refunded）时改写 bookingKey 为此值 */
function releasedBookingKey(orderId) {
    return `released_${orderId}_${Date.now()}`;
}
exports.releasedBookingKey = releasedBookingKey;
/** 活跃订单状态集：占用 bookingKey（这些状态下不可重复下单） */
exports.BOOKING_KEY_ACTIVE_STATUSES = [
    'pending_payment',
    'deposit_paid',
    'paid',
    'confirmed',
...
exports.BOOKING_KEY_RELEASED_STATUSES = [
    'cancelled',
    'rejected',
    'refunded',
];
