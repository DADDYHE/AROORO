...
exports.LOG_LEVELS = exports.installGlobalExceptionHandlers = exports.perfSample = exports.getLogLevel = exports.setLogLevel = exports.createLogger = exports.logger = void 0;
 ...
 */
function perfSample(service, action, duration, metadata = {}) {
    if (PERF_SAMPLING_RATE <= 0)
        return;
