...
exports.cancelServiceIncomeRecord = exports.createActivityIncomeRecords = exports.createServiceIncomeRecord = void 0;
 ...
 */
async function createServiceIncomeRecord(providerId, type, orderId, amount, orderNo, description) {
    try {
...
exports.createServiceIncomeRecord = createServiceIncomeRecord;
/**
 * 批量创建活动收入记录
 ...
 */
async function createActivityIncomeRecords(activityId, creatorId) {
    try {
...
exports.createActivityIncomeRecords = createActivityIncomeRecords;
/**
 * 取消服务收入记录
 *
 * 调用时机：
 ...
 */
async function cancelServiceIncomeRecord(orderId, type) {
    try {
        if (!orderId || !type) {
...
exports.cancelServiceIncomeRecord = cancelServiceIncomeRecord;
// =====================================================================
