...
async function getMyIncomeOverview(event, context, auth) {
    ...
    try {
        ...
        try {
            ...
            logger.warn('getMyIncomeOverview.feeders.fetch', { openid, msg: e.message });
        }
        ...
        const [commissionByOrderTypeAgg, commissionByOrderTypeStatusAgg, commissionByOrderTypeMonthlyAgg, commissionByOrderTypeTodayAgg, boardingTotalAgg, boardingMonthlyAgg, boardingTodayAgg, feedingTotalAgg, feedingMonthlyAgg, feedingTodayAgg, commissionWalletRes, serviceWalletRes,] = await Promise.all([
...
async function getMyIncomeDetails(event, context, auth) {
    ...
    try {
        ...
        if (type !== 'all') {
            ...
            if (type === 'tuan')
                where.orderType = 'tuan';
            else if (type === 'mall')
                where.orderType = 'mall';
        }
