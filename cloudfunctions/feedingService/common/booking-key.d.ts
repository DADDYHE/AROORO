...
export declare function buildBookingKey(params: {
    hostId: string;
    startDate: string;
    endDate: string;
    startAt?: string;
...
export declare function releasedBookingKey(orderId: string): string;
/** 活跃订单状态集：占用 bookingKey（这些状态下不可重复下单） */
export declare const BOOKING_KEY_ACTIVE_STATUSES: string[];
/** 终态：不占用 bookingKey（已释放） */
export declare const BOOKING_KEY_RELEASED_STATUSES: string[];
