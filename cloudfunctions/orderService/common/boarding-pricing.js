...
exports.computeBoardingAmount = exports.DEFAULT_BILLING_MODE = exports.DEFAULT_CHECK_OUT_BEFORE = void 0;
exports.DEFAULT_CHECK_OUT_BEFORE = '12:00';
exports.DEFAULT_BILLING_MODE = 'hotel';
...
function computeHotel(input) {
    const { pricePerDay, startDate, startAt, endDate, endAt, petCount = 1, checkOutBefore = exports.DEFAULT_CHECK_OUT_BEFORE, } = input;
    ...
    const checkOutMin = parseTimeToMinutes(checkOutBefore) ?? parseTimeToMinutes(exports.DEFAULT_CHECK_OUT_BEFORE);
...
function computeHourly24(input) {
    const { pricePerDay, startDate, startAt, endDate, endAt, petCount = 1, } = input;
    const startUtc = parseDateToUTCms(startDate);
    const endUtc = parseDateToUTCms(endDate);
    if (startUtc === null || endUtc === null) {
        throw new Error('INVALID_PARAMS: 日期格式必须为 YYYY-MM-DD');
...
function computeBoardingAmount(input) {
    const mode = input.mode === 'hourly24' ? 'hourly24' : exports.DEFAULT_BILLING_MODE;
    ...
    const normalized = {
        ...
        pricePerDay,
        petCount,
        checkOutBefore: input.checkOutBefore || exports.DEFAULT_CHECK_OUT_BEFORE,
    };
    return mode === 'hourly24' ? computeHourly24(normalized) : computeHotel(normalized);
}
exports.computeBoardingAmount = computeBoardingAmount;
exports.default = { computeBoardingAmount, DEFAULT_BILLING_MODE: exports.DEFAULT_BILLING_MODE, DEFAULT_CHECK_OUT_BEFORE: exports.DEFAULT_CHECK_OUT_BEFORE };
