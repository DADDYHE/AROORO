...
const TUAN_STATUS = { pending: '待确认', pending_payment: '待支付', paid: '已支付', confirmed: '已确认', completed: '已完成', cancelled: '已取消' }
const statusFilter = ref('')
const autoRefresh = ref(true)
let refreshTimer = null

const { list, loading, total, pagination, fetch, onPageChange, onSizeChange } = usePagination(getTuanDealOrders)
