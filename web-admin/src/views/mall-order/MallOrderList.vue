  ...
  <el-card>
    ...
    <el-table :data="list" v-loading="loading" stripe>
      ...
      <el-table-column label="操作" width="120" fixed="right">
        <template #default="{ row }">
          <el-button link type="primary" @click="$router.push(`/order/mall/${row._id}`)">详情</el-button>
        </template>
      </el-table-column>
    </el-table>
...
const MALL_STATUS = { pending_payment: '待支付', paid: '已支付', confirmed: '已确认', shipped: '已发货', completed: '已完成', cancelled: '已取消' }
