...
console.log('CustomMessage: 全局a.functions 已初始化');

// 使用require语句代替import语句，这样可以控制模块加载的顺序
// 使用相对路径，从当前文件位置开始计算
const formateTime = require('../../../../utils/formate-time').default;
const constant = require('../../../../utils/constant').default;
...
try {
  ...
  console.log('CustomMessage: TUICore.functions 已初始化');
} catch (error) {
  console.warn('CustomMessage: TUICore 初始化失败:', error);
}
